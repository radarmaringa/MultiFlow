...
class CompaniesSettings extends Model<CompaniesSettings> {
  ...
  // Configurações de notificação de tickets não atendidos
  @Default("disabled")
  @Column
  enableUnattendedTicketNotification: string;

  @Default(15)
  @Column
  unattendedTicketTimeoutMinutes: number;

  @Column
  unattendedTicketNotificationMessage: string;
}

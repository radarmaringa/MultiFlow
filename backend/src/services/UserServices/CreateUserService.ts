...
interface Request {
  ...
  enableUnattendedTicketNotification?: string; // 🆕 NOVO CAMPO
  unattendedTicketNotificationPhone?: string;  // 🆕 NOVO CAMPO
  unattendedTicketTimeout?: number;            // 🆕 NOVO CAMPO
}
...
const CreateUserService = async ({
  ...
  enableUnattendedTicketNotification = "disabled", // 🆕 NOVO CAMPO
  unattendedTicketNotificationPhone,               // 🆕 NOVO CAMPO
  unattendedTicketTimeout = 15                     // 🆕 NOVO CAMPO
  ...
  const user = await User.create(
    {
      ...
      enableUnattendedTicketNotification, // 🆕 NOVO CAMPO
      unattendedTicketNotificationPhone,   // 🆕 NOVO CAMPO
      unattendedTicketTimeout              // 🆕 NOVO CAMPO
    },
